					...
					<div className="right">
						<div className="resources">
							...
							<div className="second">
								<h3 className="text-[16px] font-semibold ">Connect with us</h3>
								<ul>
									<li>
							...
							<div className="third">
								...
								<form
									...
									<input
										...
										spellCheck="false"
										className="rounded-full px-4 border-[2px] !border-richblack-900 !bg-richblack-5 py-2 w-[250px]"
										value={email}
										onChange={handleEmailChange}
										required
									/>
									<button type="submit">
										<i className="fa-solid fa-arrow-right ml-[-110px] mt-2"></i>
									</button>
								</form>
